...
func (c *cli) setupConfig(cmd *cobra.Command, _ []string) error {
	var err error
	...
	c.cfg.StartJoinAddresses = viper.GetStringSlice("start-join-addresses")
...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().StringSlice("start-join-addresses",
		nil,
